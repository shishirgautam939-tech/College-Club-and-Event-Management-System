...
// Certificate PDFs are fetched with expo-file-system's downloadAsync
// (src/utils/downloadFile.js) rather than axios — native download straight
// to disk, no binary bodies through the RN bridge.
